Public Class frmBack
    ...
    Private Sub ShowDir()
        ...
        lblShowDir.Text = Application.StartupPath & "\resurse\4. Probleme backtracking"
    ...
    Private Sub teorieBack_Click(sender As Object, e As EventArgs) Handles teorieBack.Click
        Process.Start(Application.StartupPath & "\resurse\HTML\Backtracking.html")
    End Sub
End Class